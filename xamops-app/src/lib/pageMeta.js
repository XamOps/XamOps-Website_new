...
export const PAGE_META = {
  ...
  '/blog/sre-services-india': {
    ...
    description: "Site Reliability Engineering Services help businesses build more stable, scalable digital infrastructure. See how Xamops supports SRE across Noida, Delhi NCR, Bangalore, Hyderabad, and Jaipur.",
    keywords: 'Site Reliability Engineering Services, SRE Services Noida, SRE Services Delhi NCR, SRE Services Bangalore, SRE Services Hyderabad, SRE Services Jaipur, SRE vs DevOps, Cloud Infrastructure Reliability, Xamops',
    ...
    schemas: [
      {
        ...
        keywords: [
          ...
          'SRE Services in Noida',
          'SRE Services in Delhi NCR',
          'SRE Services in Bangalore',
          'SRE Services in Hyderabad',
          'SRE Services in Jaipur',
          'SRE vs DevOps',
          'cloud infrastructure reliability',
        ],
        mainEntityOfPage: { '@type': 'WebPage', '@id': `${BASE}/blog/sre-services-india/` },
        isPartOf: { '@type': 'Blog', '@id': `${BASE}/blog/#blog` },
        about: { '@type': 'Thing', name: 'Site Reliability Engineering Services' },
      },
      {
        '@type': 'FAQPage',
        ...
        mainEntity: [
          ...
          { '@type': 'Question', name: 'Can XamOps provide SRE solutions for cloud infrastructure?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. XamOps focuses on SRE and cloud operations practices that can help businesses manage modern infrastructure, improve reliability, and automate operational processes.' } },
          { '@type': 'Question', name: 'What is the difference between SRE and DevOps?', acceptedAnswer: { '@type': 'Answer', text: 'DevOps focuses on collaboration and improving software delivery between development and operations teams. SRE applies software engineering principles to reliability and operational challenges. Both approaches can work together to improve software delivery and infrastructure reliability.' } },
