...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Athena, Lambda, and CloudWatch are usage-priced and often invisible until they aren\'t. Athena charges per TB of data scanned — a single unpartitioned query on a large S3 bucket can cost more than a day\'s worth of EC2. Lambda invocation counts can spike if a misconfigured event source starts firing at 10× the expected rate. CloudWatch log ingestion bills by the gigabyte — verbose logging during a debugging session that was never turned off keeps charging indefinitely. Check each service\'s usage metrics for the spike period.',
  ...
  return (
    <>
      ...
      <section className="sec-light pt-28 md:pt-36 pb-12 relative overflow-hidden">
        <div
          className="absolute -top-24 left-1/2 -translate-x-1/2 w-[800px] h-[500px] rounded-full pointer-events-none"
          style={{ background: 'radial-gradient(closest-side, rgba(124,92,255,0.09), transparent 70%)' }}
        />
        <div className="max-w-[820px] mx-auto px-6 md:px-10 relative">
          {/* Breadcrumb / meta */}
          ...
          <h1 className="serif text-[clamp(34px,5.2vw,66px)] leading-[1.06] tracking-tight">
          ...
          <p
            ...
            style={{ color: 'var(--olive)', maxWidth: '62ch' }}
          >
      ...
      {/* Divider */}
      <div
        className="max-w-[820px] mx-auto px-6 md:px-10"
        style={{ height: '1px', background: 'var(--rule)' }}
      />

      {/* ── Article body ────────────────────────────────────────── */}
      <article className="sec-light py-14 md:py-20">
        <div className="max-w-[820px] mx-auto px-6 md:px-10">

          {/* Hook */}
          <section className="mb-14">
            <p className="text-[17px] leading-[1.78]" style={{ color: 'var(--ink-2)' }}>
              It&rsquo;s Monday morning. You open Slack and see three messages from the finance team — all in
              the last hour. Your AWS bill came in 40% above the previous month. No major deployment
              happened. No launch, no traffic spike you know of. The Cost Explorer alert that was supposed
              to catch this? It didn&rsquo;t fire. Now you have until end of day to explain what happened and
              produce a remediation plan.
            </p>
            <p className="text-[17px] leading-[1.78] mt-5" style={{ color: 'var(--ink-2)' }}>
              This checklist is what we wish we&rsquo;d had the first time that happened. Seven steps, in order
              of most likely cause to most obscure, each with a direct path to the answer inside the AWS
              console — and a note on where XamOps would have caught it before finance did.
            </p>
          </section>
          ...
          <section className="mb-14">
            <h2
              className="serif text-[clamp(24px,3.8vw,38px)] leading-[1.1] tracking-tight mb-5"
            >
              Why AWS Cost Spikes Are Hard to Diagnose
            </h2>
            <p className="text-[17px] leading-[1.78]" style={{ color: 'var(--ink-2)' }}>
              AWS Cost Explorer has a 24-hour reporting lag. Billing dimensions are spread across dozens of
              service-specific consoles. A single forgotten resource can hide in the statistical noise of a
              large account. And unlike application errors, there is no stack trace — just a larger number
            ...
            <p className="text-[17px] leading-[1.78] mt-4" style={{ color: 'var(--ink-2)' }}>
              ...
              regions, availability zones, account IDs, and resource tags (when those tags exist at all).
              Finding the spike means narrowing from the entire billing surface down to a single resource or
              behavior — and doing it fast enough to actually fix something before next month&rsquo;s bill arrives.
            </p>
            <p className="text-[17px] leading-[1.78] mt-4" style={{ color: 'var(--ink-2)' }}>
              This is not a reflection on your engineering competence. The tooling is genuinely fragmented.
              The checklist below is a proven sequence for cutting through that noise systematically.
            </p>
          </section>
          ...
          <div className="mb-8">
            ...
            <h2 className="serif text-[clamp(24px,3.8vw,38px)] leading-[1.1] tracking-tight">
              ...
              >
                <div className="p-7 md:p-9">
                  ...
                  <div className="flex items-start gap-4 mb-5">
                    ...
                    <h3 className="serif text-[clamp(19px,2.8vw,26px)] leading-[1.2] tracking-tight pt-1">
                      {step.title}
                    </h3>
                  </div>
                  ...
                  >
                    ...
                    >
                      <span className="eyebrow" style={{ fontSize: '10px', letterSpacing: '0.2em' }}>
                        Where to look
                      </span>
                    </div>
                    <div
                  ...
                  <div
                    ...
                    style={{
                      background: 'rgba(240,179,65,0.07)',
                      border: '1px solid rgba(240,179,65,0.18)',
                    }}
                  >
                    <span
                      className="shrink-0 mt-px text-[12px] font-bold"
                  ...
                  <div
                    ...
                    style={{
                      ...
                      border: '1px solid rgba(43,212,168,0.18)',
                    }}
                  >
                    <span
                      className="shrink-0 mt-px text-[11px]"
          ...
          {/* Root cause pattern */}
          <section className="mb-14">
            <h2 className="serif text-[clamp(24px,3.8vw,38px)] leading-[1.1] tracking-tight mb-5">
              The Root Cause Pattern
            </h2>
            <p className="text-[17px] leading-[1.78] mb-7" style={{ color: 'var(--ink-2)' }}>
              After running this checklist across hundreds of cost spikes, the root cause almost always
              traces back to one of three patterns:
            </p>
            ...
            <p className="text-[17px] leading-[1.78] mt-7" style={{ color: 'var(--ink-2)' }}>
              The checklist above is ordered to hit all three. Start at the service level, narrow to the
              resource type, and follow the money.
            </p>
          </section>

          {/* XamOps close section */}
          <section
            className="rounded-2xl p-8 md:p-10 ring-soft relative overflow-hidden"
            style={{ background: 'var(--ivory)' }}
          >
            <div
              className="absolute -right-20 -bottom-20 w-[360px] h-[360px] rounded-full pointer-events-none"
              style={{
                background: 'radial-gradient(closest-side, rgba(43,212,168,0.09), transparent 70%)',
              }}
            />
            <div className="relative">
              <div className="eyebrow mb-3">How XamOps automates this</div>
              <h2 className="serif text-[clamp(22px,3.5vw,36px)] leading-[1.1] tracking-tight mb-5">
              ...
              <p className="text-[15.5px] leading-[1.78] mb-4" style={{ color: 'var(--ink-2)' }}>
                The investigation above takes a skilled engineer 2–4 hours the first time — longer if
                they&rsquo;re new to the account. And it has to be repeated every time a spike happens, because
                AWS doesn&rsquo;t maintain the institutional memory of what normal looks like.
              </p>
              <p className="text-[15.5px] leading-[1.78] mb-4" style={{ color: 'var(--ink-2)' }}>
                XamOps monitors all seven of these dimensions continuously, across AWS, GCP, and Azure, in
                near-real time. When something deviates — a Spot fallback, a new orphaned volume, an unusual
                data transfer pattern — you get an anomaly alert before the billing period closes. The Waste
                &amp; Cost dashboard shows the root cause in a single view: which resource, which account,
                which team, and the projected monthly impact.
              </p>
              <p className="text-[15.5px] leading-[1.78] mb-8" style={{ color: 'var(--ink-2)' }}>
                No Cost Explorer pivot tables. No manual inventory audits. No Monday morning Slack messages
                from finance.
              </p>
